...
# Define a function for dataset processing and image generation with bilinear interpolation
def generate_images(data_path):
    ...
    output_folder_benign = 'data/BENIGN2'
    output_folder_malicious = 'data/MALICIOUS2'
